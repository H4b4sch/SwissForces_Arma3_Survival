...
private["_buildingname","_chfullfuel","_chperSpot","_class","_dbgloopTime","_dbgloopTimeplU","_dbgTime","_dbgTurns",
				"_dbgTurnsplU","_endloop","_genZadjust","_hndl","_item","_nearLootdist","_pos","_posAdjustZ","_posAdjustZlist",
				"_poscount","_posIdxlist","_posnew","_posOrg","_posViable","_randomweapontestint","_spawnradius","_spInterval",
				"_testpos","_tmpBuild","_tmpPoslist","_tmpTstPlace","_z"];
//-------------------------------------------------------------------------------------
//Switch
...
// Global
var_randomLootDefenseMkrIndex = 0;

//-------------------------------------------------------------------------------------
//Variables
//local
_spawnradius = 100;					//Radius (in meter) around players to spawn loot
_spInterval = 14400;				//Time (in sec.) to pass before a building spawns new loot
_chfullfuel = 0;						//Chance (in %) of a spawned fuelcan to be full instead of empty
...
_chperSpot = 15;						//Chance (in %) if a spot gets loot. Will be considered before 'spawnClassChance_list'
