...
tcb_ais_random_lifetime_factor 	= 	30;			//	a higher value means you got more time to heal the unit before bleeding out and die (50 == means round about 1 minute, 100 == means round about 3 minutes, 200 == approximately 8 minutes)
